...
import main.com.manage.teacher.AddStudentUI;
import main.com.manage.teacher.MyStudentUI;
import main.com.manage.teacher.SearchStuUI;
import main.com.manage.teacher.TeacherUI;
...
public class MainJF extends JFrame {
    ...
    public MainJF() {
        ...
        lblNewLabel_1.setIcon(new ImageIcon(MainJF.class.getResource("/main/images/bookmaintain.png")));
        ...
        lblNewLabel.setIcon(new ImageIcon(MainJF.class.getResource("/main/images/main.PNG")));
        ...
        lblNewLabel_2.setIcon(new ImageIcon(MainJF.class.getResource("/main/images/bookManager.png")));
        ...
        label.setIcon(new ImageIcon(MainJF.class.getResource("/main/images/bookmaintain.png")));
